# أصول متجر Google Play — لوحة المالك

حزمة التطبيق (applicationId): `com.khawarizmie.medjat_admin`
...
مولّدة من `assets/icons/superadmin.svg` ضمن تصدير 2026-09-08. لإعادة التوليد راجع
