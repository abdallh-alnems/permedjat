...
```
store_assets/
├── google_play/   ← أصول Google Play (Android · حزمة com.khawarizmie.medjat_admin)
...
الأيقونات تُولَّد من `assets/icons/superadmin.svg` — راجع `assets/icons/README.md`.
