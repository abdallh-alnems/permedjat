...
```
store_assets/
├── google_play/   ← أصول Google Play (Android · حزمة com.khawarizmie.medjat)
...
│
└── app_store/     ← أصول App Store (iOS · حزمة com.khawarizmie.medjat)
    ├── icon/                  أيقونة 1024×1024 (بلا شفافية)
    ├── screenshots/           raw/ الخام ← iphone_6_5/ النهائية
    └── README.md
```

الأيقونات تُولَّد من `assets/icons/employee.svg` — راجع `assets/icons/README.md`.
